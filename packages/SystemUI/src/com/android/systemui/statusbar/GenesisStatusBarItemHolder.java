...
import com.android.internal.statusbar.GenesisStatusBarItem;

import java.util.ArrayList;

public class GenesisStatusBarItemHolder extends RelativeLayout
        implements GenesisStatusBarItem.Manager {
    private static final String TAG = "GenesisStatusBarItemHolder";

    private ArrayList<GenesisStatusBarItem.DarkReceiver> mDarkReceivers =
            new ArrayList<GenesisStatusBarItem.DarkReceiver>();
    private ArrayList<GenesisStatusBarItem.VisibilityReceiver> mVisibilityReceivers =
            new ArrayList<GenesisStatusBarItem.VisibilityReceiver>();
    ...
    public GenesisStatusBarItemHolder(Context context) {
        this(context, null);
    }

    public GenesisStatusBarItemHolder(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GenesisStatusBarItemHolder(Context context, AttributeSet attrs, int defStyle) {
    ...
    private DarkReceiver mDarkReceiver = new DarkReceiver() {
        ...
        public void onDarkChanged(ArrayList<Rect> areas, float darkIntensity, int tint) {
            ...
            mLastTint = tint;
            for (GenesisStatusBarItem.DarkReceiver r : mDarkReceivers) {
    ...
    private void updateVisibilityReceivers(boolean isVisible) {
        ...
        for (GenesisStatusBarItem.VisibilityReceiver r : mVisibilityReceivers) {
            r.onVisibilityChanged(mItemHolderIsVisible);
        }
    }

    // GenesisStatusBarItem.Manager methods

    public void addDarkReceiver(GenesisStatusBarItem.DarkReceiver darkReceiver) {
    ...
    public void addVisibilityReceiver(GenesisStatusBarItem.VisibilityReceiver visibilityReceiver) {

...
public class NetworkTraffic extends TextView {
    ...
    private final GenesisStatusBarItem.DarkReceiver mDarkReceiver =
            new GenesisStatusBarItem.DarkReceiver() {
    ...
    private final GenesisStatusBarItem.VisibilityReceiver mVisibilityReceiver =
            new GenesisStatusBarItem.VisibilityReceiver() {
    ...
    protected void onAttachedToWindow() {
        ...
        GenesisStatusBarItem.Manager manager = GenesisStatusBarItem.findManager((View) this);
